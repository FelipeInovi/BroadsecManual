...
Vea `../../COMO-ENTREGAR-IMAGENES.md` para la regla de nombres y los pasos.
Este documento sirve para un caso puntual: emparejar las 133 imágenes que ya se
extrajeron del PDF v5 con los slots que las esperan.

## introduccion

Conteos iguales (1): ya emparejado por orden y entregado.
...
El PDF v5 no trae epígrafes, así que el orden es el único indicio y con
conteos distintos se desfasa. *Candidata* es una **propuesta por orden**:
en cuanto una fila no corresponda, todas las de abajo están corridas.
...
Conteos iguales (3): ya emparejado por orden y entregado.
