...
| `bot.pmv.paso.identificar` — Identifique el mensaje | 75 |  |
| `bot.pmv.paso.clasificar` — Clasifique el mensaje | 75 |  |
| `bot.pmv.paso.destino` — Seleccione los paneles de destino | 76 |  |
| `bot.pmv.paso.contenido` — Componga el contenido | 76 |  |
| `bot.pmv.paso.vigencia` — Defina la vigencia | 76 |  |
| `bot.pmv.paso.guardar` — Guarde el mensaje | 76 |  |
| `bot.pmv-gestion.paso.desactivar` — Accione Desactivar sobre el mensaje | 78 |  |
...
| `bot.pmv-variables.paso.anadir` — Inicie la creación | 81 |  |
| `bot.pmv-variables.paso.nombrar` — Nombre el grupo | 81 |  |
| `bot.pmv-variables.paso.seleccionar` — Seleccione los paneles | 81 |  |
| `bot.alarmas.paso.filtrar` — Acote el listado | 82 |  |
| `bot.alarmas.paso.seleccionar` — Seleccione las alarmas | 83 |  |
| `bot.alarmas.paso.reconocer` — Accione Reconocer | 83 |  |
| `bot.alarmas.paso.resultado` — Verifique el resultado | 83 |  |
